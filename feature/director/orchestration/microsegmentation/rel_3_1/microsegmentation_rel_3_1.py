...
from feature.director.orchestration.microsegmentation.rel_3_1.inventory_rel_3_1 import VaInventory


class VaMicrosegmentation_3_1(VaInventory):
    """
    ...
    def va_dp_deployment(self, instance, data):
        """
        deploy va vm
    ...
    def va_reverse_dp_deployment(self, instance, data, jobid=None):
        """
        remove deployment
    ...
    def va_check_dp_deployment_status(self, jobid=None):
        """
